...
The module passes the component's IRI as a prop. `useCwaComponent` fetches and subscribes to the resource. `defineExpose(exposeMeta)` wires the component into the admin manager.
