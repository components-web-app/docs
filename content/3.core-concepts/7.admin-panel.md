...
- **Live** — public now
- **Scheduled** — public from the date and time you pick. The picker uses your browser's timezone and says which one it is committing to
...
::callout{icon="i-heroicons-photo"}
IMAGE: The route editor's Visibility select set to "Scheduled", with the "Goes live" date-time field and the "Times are in …" timezone note beneath it
::
