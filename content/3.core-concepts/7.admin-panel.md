...
Scheduling was added after `@cwa/nuxt` `2.0.0-alpha.1`, and the toggle after that. Until the next tagged release, use `@cwa/nuxt-edge` from the module's `dev` branch.
