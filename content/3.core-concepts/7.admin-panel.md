...
IMAGE: The admin bar across the top of a live page — Edit/Done toggle, the Layouts | Pages | Data | Routes | Users | Settings links, the page title input, and the API loading indicator
::
...
VIDEO: Dragging a component to a new position within a group, showing the drop indicator and the order persisting after release
::
