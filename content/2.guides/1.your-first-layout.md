...
The `classes` array defines the style options an editor can choose from for this layout. `useCwaLayout()` applies the selected classes to the root element automatically.
