...
| `/_cwa/orphaned` | The last orphaned resource report: view and delete orphaned components, positions and groups. Opened from site settings, which can also start a scan. See [Orphaned Resources](/core-concepts/admin-panel#orphaned-resources). Added in `@cwa/nuxt` `2.0.0-alpha.3` |
