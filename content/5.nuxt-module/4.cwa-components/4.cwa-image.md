...
For full control over loading states, skeleton markup, and multi-variant access, build a custom component using [`useCwaImageResource`](/nuxt-module/composables/use-cwa-image-resource) directly. See [Images & Uploads](/nuxt-module/component-helpers/images-and-uploads) for the complete pattern.
