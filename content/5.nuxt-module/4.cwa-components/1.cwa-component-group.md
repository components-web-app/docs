...
::callout{icon="i-heroicons-information-circle"}
**Added after `2.0.0-alpha.1`:** component names, `CwaComponentNames`, and syncing groups that have no stored list. Until the next tagged release, they need `@cwa/nuxt-edge` `0.0.0-29839156.93ca8a0` or later.
::
