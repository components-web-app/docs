...
Tagged releases, from `2.0.0-alpha.1` on, are listed in the module's [`CHANGELOG.md`](https://github.com/components-web-app/cwa-nuxt-module/blob/main/CHANGELOG.md) and on its [GitHub releases](https://github.com/components-web-app/cwa-nuxt-module/releases), which use the same notes. Changes on `dev` that aren't in a release yet are under **Unreleased** in the [`dev` branch's copy](https://github.com/components-web-app/cwa-nuxt-module/blob/dev/CHANGELOG.md). For the API bundle's changes, see [Bundle Setup](/api/bundle-setup#installation).
