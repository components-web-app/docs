...
| `pageCache` | `{ enabled?, sharedMaxAge?, staleWhileRevalidate? }` | `{ enabled: true, sharedMaxAge: 3600, staleWhileRevalidate: 0 }` | Shared-cache headers for rendered page HTML. See [Page Caching](/nuxt-module/page-caching) |
