...
By default, CWA subscribes to exact IRI topics. To subscribe to additional topics (e.g. a wildcard for a category of resources), configure them on the hub and add the subscription in a custom plugin. This is an advanced use case — the default behaviour covers all standard CWA content types.
