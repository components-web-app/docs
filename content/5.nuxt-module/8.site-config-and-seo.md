...
CWA stores site-wide settings in the API and caches them in Pinia. Admins change them at `/_cwa/settings` — no deploy required. The module automatically applies title, meta description, canonical URL, and robots tags from these settings and per-page overrides.
