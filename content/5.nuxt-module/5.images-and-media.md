...
} = useCwaResourceUpload(toRef(props, 'iri'), 'file')  // 'file' = the PHP property name
</script>
```

`useCwaResourceUpload(iri, propertyName)` handles the file selection, base64 encoding, API upload, and deletion.
