...
While edit mode is on, the admin blocks **programmatic** router navigation (`push`, `replace`, `go`, `back`, `forward`) so you can't leave a page mid-edit. Navigation the user triggers themselves is never blocked.
