...
The **Purge page cache**, **Purge all cached data** and **Warm page cache** buttons in site settings call these methods. See [Page Caching](/nuxt-module/page-caching#warming-the-cache-from-site-settings) for how the warm works, and [Purging all cached data](/nuxt-module/page-caching#purging-all-cached-data) for when to use the full purge.
