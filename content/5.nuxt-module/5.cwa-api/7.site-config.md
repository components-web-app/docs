...
The **Purge page cache** and **Warm page cache** buttons in site settings call these two methods. See [Page Caching](/nuxt-module/page-caching#warming-the-cache-from-site-settings) for how the warm works.
