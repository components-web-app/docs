...
When `pagesDepth > 1`, pages can nest. Access specific depth levels:

```ts
cwa.resources.depthCount                   // ComputedRef<number>
cwa.resources.pageAtDepth(0)               // ComputedRef — outermost page
cwa.resources.pageAtDepth(1)               // ComputedRef — first nested page
