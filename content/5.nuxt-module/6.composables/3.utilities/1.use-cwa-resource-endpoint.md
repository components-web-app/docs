...
The composable is used internally by `useCwaResource` (and by extension `useCwaComponent`) — you only need it when building custom fetch logic outside of those composables.
