...
**Deprecated.** Use [`useCwaComponent(props, [withImage()])`](/nuxt-module/composables/component/use-cwa-component#withimage-imagops) instead. This composable still works but may be removed in a future version.
::

For components backed by a PHP entity with `#[Silverback\Uploadable]` — wraps `useCwaResource` with image URL and load state.
