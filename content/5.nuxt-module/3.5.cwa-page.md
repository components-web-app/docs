...
For the API side of nested pages — setting `parentPage` / `parentPageData` in PHP, route auto-prefixing, cascading renames, and the resource manifest format — see [Dynamic & Nested Pages](/back-end/dynamic-pages).
