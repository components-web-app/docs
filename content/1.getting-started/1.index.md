...
The [components-web-app template](https://github.com/components-web-app/components-web-app) is the starting point for every CWA project. Clone it and you have a complete local stack, JWT authentication pre-wired, and a working example site with fixture data ready to load.
