...
The `silverback:api-components:purge-http-cache` command does the same flush. See [Purging all cached data](/nuxt-module/page-caching#purging-all-cached-data).
