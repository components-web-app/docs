---
title: CI/CD
description: The template's GitLab CI pipeline — Docker Buildx builds, PHPUnit + Behat tests, per-branch review apps, and staged Kubernetes deployments via Helm.
---
