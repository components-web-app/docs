...
- **From bundle `2.0.0-alpha.5`**, which the template pins, appending creates only what is missing and keeps existing content. See [Appending to an Existing Site](/api/data-fixtures#appending-to-an-existing-site).
