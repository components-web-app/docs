...
Use `useCwaImageResource` in your Vue component instead of `useCwaResource`. It adds `contentUrl`, `displayMedia`, `loaded`, and `handleLoad` — see [Images & Media](/nuxt-module/images-and-media) for the full reference.
