...
Use `useCwaCollectionResource` in the Vue component. It unwraps `collection.hydra:member`, exposes `totalPages`, and provides `goToNextPage` / `goToPreviousPage` helpers — see [Collections & Pagination](/nuxt-module/component-helpers/collections-and-pagination) for the full reference.
