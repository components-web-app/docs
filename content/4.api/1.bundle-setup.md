...
::callout{icon="i-heroicons-exclamation-triangle" color="warning"}
**Include the version constraint.** CWA 2 is released as alphas (`2.0.0-alpha.3` is the newest). Without `^2.0@alpha`, a project with the usual `minimum-stability: stable` gets `1.1.11`, the last 1.x release, which these docs don't describe. To follow unreleased changes, require `2.x-dev`: `main` is aliased to it.
::
