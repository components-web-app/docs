...
It takes no arguments or options. Run it after a front-end deploy; `POST /_/rendered_html/purge` as an admin does the same. If no HTTP cache purger is configured it does nothing and still succeeds. See [Page Caching](/nuxt-module/page-caching).
