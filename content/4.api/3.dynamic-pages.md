...
When an admin renames a parent route, `PATCH /_/routes/{id}` with `cascadeChildPaths: true` updates the entire subtree and creates `301` redirects from every old path:
...
```json
{
  "children": [
    {
      "route": "/_/routes/b2c3d4",
      "path": "/events/2024",
      "children": [
        {
          "route": "/_/routes/e5f6a7",
